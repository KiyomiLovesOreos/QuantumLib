...
assert(load(NFS.read(mod_path .. "src/j_phase.lua"),           "=[QuantumLibDemo] src/j_phase.lua"))()
assert(load(NFS.read(mod_path .. "src/j_qubit.lua"),           "=[QuantumLibDemo] src/j_qubit.lua"))()
assert(load(NFS.read(mod_path .. "src/j_observer.lua"),        "=[QuantumLibDemo] src/j_observer.lua"))()
...
QuantumLib.enable_cycle_tooltip()
QuantumLib.enable_cycle_badges()
QuantumLib.enable_cycle_deck_view()
QuantumLib.enable_superposition_persistence()
QuantumLib.enable_superposition_tooltip()
QuantumLib.enable_superposition_badges()
QuantumLib.enable_superposition_deck_view()
